...
class Accident(ABC):
    ...
    # Let's add the game keyword parameter 
    # to the constructor.
    def __init__(self, name, 
        ...
        # We'll need to access the Game object.
        self.game = game
...
class GrassAccident(Accident):
    ...
    def continue_race(self, dt):
        ...
        # We now have access to the Game object, so let's bind its
        # two methods to the animation's events.
