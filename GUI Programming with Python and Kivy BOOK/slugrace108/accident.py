...
# the classes we need for the popup window
from kivy.uix.popup import Popup
from kivy.uix.label import Label
from kivy.uix.image import Image
from kivy.uix.boxlayout import BoxLayout

# We'll need the choice function to randomly pick a headline.
...
class Accident(ABC):
    ...
    @abstractmethod
    def happen(self):
        # Let's randomly pick a headline and assign it to a variable.
        headline = choice(self.headlines)

        # Let's create the label that will display the headline.
